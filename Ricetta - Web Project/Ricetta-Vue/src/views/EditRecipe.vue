<template>
  <div>
    ...
    <Navigate></Navigate>
    <br />
              <div class="container-fluid" style="background-color:#E3F6FF">
              </div>
    <div class="container">
      <form>
        <div class="well">
          ...
          <h4 style="font-weight: bold">
            Recipe <span class="badge badge-success">Edit</span>
          </h4>
          <!-- ------------------------------- Recipe Image ----------------------------------- -->
...
export default {
  ...
  methods: {
    ...
    updateToAPI() {
      ...
      axios
        .post("https://young-basin-17632.herokuapp.com/recipe/edit/"+this.$route.params.recipeID, newRecipe)
        .then((response) => {
  ...
  mounted() {
    axios
      .get("https://young-basin-17632.herokuapp.com/recipe/show/id/" + this.$route.params.recipeID)
      .then((response) => {
        console.log(response.data)
        this.formRecipe = response.data;
        // change array to string and replace comma to ;
        this.formRecipe.ingredients = response.data.ingredients.toString()
        console.log(this.formRecipe.ingredients)
        this.formRecipe.ingredients = this.formRecipe.ingredients.replace(",",";")

        this.formRecipe.instructions = response.data.instructions.toString()
        console.log(this.formRecipe.instructions)
        this.formRecipe.instructions = this.formRecipe.instructions.replace(",",";")
      })
      .catch((error) => {
        console.log(error);
      });
